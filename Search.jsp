	...
	<div class="container">
		<div class="top-header-main">
			...
			<div class="col-md-4 top-header-middle">
				<a href="index.jsp"><img src="<n:url value="/resources/images/logo-4.png"/>" alt="" /></a>
			</div>
						...
						<div class="col-md-9 p-left">
							<div class="product-one">
								<div class="col-md-4 product-left single-left"> 
									...
									<spring:checkbox path="product" value="${pro.getP_name() }" style="display:none;" name="product"  />
								</div>
							</div>
						</div>
					</n:forEach>
